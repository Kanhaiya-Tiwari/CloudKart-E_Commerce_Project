...
```bash
aws eks --region eu-west-1 update-kubeconfig --name cloudkart-eks-cluster
```
...
> - **Project Repository URL:** `https://github.com/kanhaiyatiwari/jenkins-shared-libraries`.
>
> [Notes:] 
...
> > In **General**<br/>
> > - **Description:** CloudKart<br/>
> > - **Check the box:** `GitHub project`<br/>
> > - **GitHub Repo URL:** `https://github.com/kanhaiyatiwari/cloudkart-app`<br/>
>
> > In **Trigger**<br/>
...
> > - **SCM:** `Git`<br/>
> > - **Repository URL:** `https://github.com/kanhaiyatiwari/cloudkart-app`<br/>
...
>  -    **Namespace:**
 cloudkart-app (or your desired namespace)
...
> > kind: ConfigMap
> > metadata:
> >   name: cloudkart-config
> >   namespace: cloudkart
> > data:
> >   MONGODB_URI: "mongodb://mongodb-service:27017/cloudkart"
> >   NODE_ENV: "production"
...
> >   tls:
> >   - hosts:
> >     - cloudkart.letsdeployit.com
> >     secretName: cloudkart-tls
> >   rules:
> >   - host: cloudkart.letsdeployit.com
> >     http:
> >       paths:
> >       - path: /
> >         pathType: Prefix
...
>
>> ```bash
>> kubectl get certificate -n cloudkart
>> ```

>> ```bash
>> kubectl describe certificate cloudkart-tls -n cloudkart
>> ```
>
>> ```bash
...
>
>> ```bash
>> kubectl get challenges -n cloudkart
>> ```
>
>> ```bash
>> kubectl describe challenges -n cloudkart
>> ```
