...
1. Click "New Item"
2. Enter name: "cloudkart-pipeline"
3. Select "Pipeline"
4. Configure:
   - GitHub project URL
...
Our pipeline uses a shared library from: [CloudKart Jenkins Shared Library](https://github.com/kanhaiyatiwari/CloudKart-jenkins-shared-lib)

1. Go to "Manage Jenkins" > "Configure System"
2. Under "Global Pipeline Libraries":
   - Name: cloudkart-shared-lib
   - Default version: main
   - Modern SCM: GitHub
   - Repository URL: https://github.com/kanhaiyatiwari/CloudKart-jenkins-shared-lib.git
...
- [CloudKart Shared Library](https://github.com/kanhaiyatiwari/CloudKart-jenkins-shared-lib)
